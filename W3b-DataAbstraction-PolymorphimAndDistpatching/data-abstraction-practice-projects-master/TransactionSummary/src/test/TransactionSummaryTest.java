...
public class TransactionSummaryTest {
    ...
    public void setUp() {
        ...
        t8 = new Transaction("Coco", "May 5", 3, EDUCATION);
    ...
    public void testAverageTransactionCost() {
        ...
        assertEquals(oneSummary.averageTransactionCost(), 5, 0.0);
        assertEquals(testSummary.averageTransactionCost(), (10 + 20 + 40 + 150 + 11 + 40 + 5)/7, 0.0);
    }
    ...
    public void testspecificTypeAverage() {
        assertEquals( testSummary.specificTypeAverage(EDUCATION), 150, 0.0);
        assertEquals(testSummary.specificTypeAverage(FOOD), (20+11+5)/3, 0.0);

    }

    @Test
    public void testcontainsTransaction() {
        assertTrue(testSummary.contains(t4));
        assertFalse(testSummary.contains(t8));
